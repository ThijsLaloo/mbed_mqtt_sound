...
void messageArrived(MQTT::MessageData& md)
{
    ...
    float mesflt = atof((char*)message.payload);
    
    float spkr_period = (1.0 / mesflt);
    
    mail->sound = spkr_period;
    mail_box.put(mail);
}
...
int main(int argc, char* argv[])
{
    ...
    const char* hostname = "10.0.0.133";
    int port = 1883;
    ...
    data.MQTTVersion = 3;
    data.clientID.cstring = "tyjuukgiluooiy";
